...
{
    this->Id = other.Id;
    this->type_of_message = other.type_of_message;
...
void Packet::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->type_of_message);
    doParsimPacking(b,this->src_addr);
    doParsimPacking(b,this->dest_addr);
}
...
void Packet::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->type_of_message);
    doParsimUnpacking(b,this->src_addr);
    doParsimUnpacking(b,this->dest_addr);
}
...
const char * Packet::getType_of_message() const
{
    return this->type_of_message.c_str();
}

void Packet::setType_of_message(const char * type_of_message)
{
    this->type_of_message = type_of_message;
}

int Packet::getSrc_addr() const
{
    return this->src_addr;
}

void Packet::setSrc_addr(int src_addr)
{
    this->src_addr = src_addr;
}

int Packet::getDest_addr() const
{
    return this->dest_addr;
}

void Packet::setDest_addr(int dest_addr)
{
...
int PacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='t' && strcmp(fieldName, "type_of_message")==0) return base+1;
    if (fieldName[0]=='s' && strcmp(fieldName, "src_addr")==0) return base+2;
...
std::string PacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return oppstring2string(pp->getType_of_message());
        case 2: return long2string(pp->getSrc_addr());
...
bool PacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setType_of_message((value)); return true;
        case 2: pp->setSrc_addr(string2long(value)); return true;
