...
EXECUTE_ON_STARTUP(
    omnetpp::cEnum *e = omnetpp::cEnum::find("PktType");
    if (!e) omnetpp::enums.getInstance()->add(e = new omnetpp::cEnum("PktType"));
    e->insert(Data, "Data");
    e->insert(Ack, "Ack");
)
...
int Pkt::getMsgType() const
{
    return this->MsgType;
}

void Pkt::setMsgType(int MsgType)
{
...
std::string PktDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return enum2string(pp->getMsgType(), "PktType");
        default: return "";
    }
}
...
bool PktDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 3: pp->setMsgType((PktType)string2enum(value, "PktType")); return true;
