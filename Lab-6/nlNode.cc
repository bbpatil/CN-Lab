...
void NlNode::initialize()
{
    ...
    if(id == 4)
    {
        ...
        int CostD[5]={3,1000,1000,0,1000};
...
void NlNode::handleMessage(cMessage *msg)
{
    ...
    else
    {
        ...
        if(id == oldMsg->getDest())
        {
            ...
            {
               Pkt* newmsg = new Pkt();
               newmsg->setMid((oldMsg->getMid()+1)%2);  // %2 but..
